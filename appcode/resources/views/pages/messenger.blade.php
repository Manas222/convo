...
<link type="text/css" rel="stylesheet" href="\convo\css\messenger.css" />
</head>
...
/* if(!isset($_SESSION['uname'])){
    if($_POST['uname'] != ""){
        $_SESSION['uname'] = stripslashes(htmlspecialchars($_POST['uname']));
    }
    else{
...
<div id="wrapper">
    <div id="menu">
        <p class="welcome">Welcome, <b><?php //echo $_SESSION['uname']; ?></b></p>
        <p class="logout"><a id="exit" href="login">Logout</a></p>
    ...
    <head>
        ...
        <script>
            ...
            function register_popup(id, name)
            {
                ...
                element = element + '<div class="popup-messages-footer"><textarea id="status_message" placeholder="Type a message..." rows="10" cols="40" name="message"></textarea></div>'
